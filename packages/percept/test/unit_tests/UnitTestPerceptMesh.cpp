...
#define EXTRA_PRINT 0
      ...
      TEST(perceptMesh, test_mesh_diff)
      {
        ...
        std::string expected_serialized_mesh_string =
          "P[0] ======================================================== P[0] ========================================================P[0] ========================================================P[0] PerceptMesh::print_info: quad fixtureP[0] Uses { Node = 169 Edge = 48 Face = 0 Elem = 144 FamilyTree = 0 }P[0] info>    Number of parts = 29 P[0] info>    Part subset info:  P[0] info>     Part[0]= {UNIVERSAL} topology = INVALID_TOPOLOGY primary_entity_rank = 127 is io_part= 0 subsets = {{OWNS} , {SHARES} , {AURA} , {FEM_ROOT_CELL_TOPOLOGY_PART_NODE} , {FEM_ROOT_CELL_TOPOLOGY_PART_LINE_2} , {FEM_ROOT_CELL_TOPOLOGY_PART_LINE_3} , {FEM_ROOT_CELL_TOPOLOGY_PART_PARTICLE} , {FEM_ROOT_CELL_TOPOLOGY_PART_TRIANGLE_3_2D} , {FEM_ROOT_CELL_TOPOLOGY_PART_TRIANGLE_4_2D} , {FEM_ROOT_CELL_TOPOLOGY_PART_TRIANGLE_6_2D} , {FEM_ROOT_CELL_TOPOLOGY_PART_QUADRILATERAL_4_2D} , {FEM_ROOT_CELL_TOPOLOGY_PART_QUADRILATERAL_8_2D} , {FEM_ROOT_CELL_TOPOLOGY_PART_QUADRILATERAL_9_2D} , {FEM_ROOT_CELL_TOPOLOGY_PART_BEAM_2} , {FEM_ROOT_CELL_TOPOLOGY_PART_BEAM_3} , {FEM_ROOT_CELL_TOPOLOGY_PART_SHELL_LINE_2} , {FEM_ROOT_CELL_TOPOLOGY_PART_SHELL_LINE_3} , {FEM_ROOT_CELL_TOPOLOGY_PART_SPRING_2} , {FEM_ROOT_CELL_TOPOLOGY_PART_SPRING_3} , block_1 , surface_1 , surface_2 , surface_3 , surface_4 , surface_quad4_edge2_1 , surface_quad4_edge2_2 , surface_quad4_edge2_3 , surface_quad4_edge2_4}P[0] info>     Part[1]= {OWNS} topology = INVALID_TOPOLOGY primary_entity_rank = 127 is io_part= 0 subsets = {}P[0] info>     Part[2]= {SHARES} topology = INVALID_TOPOLOGY primary_entity_rank = 127 is io_part= 0 subsets = {}P[0] info>     Part[3]= {AURA} topology = INVALID_TOPOLOGY primary_entity_rank = 127 is io_part= 0 subsets = {}P[0] info>     Part[4]= {FEM_ROOT_CELL_TOPOLOGY_PART_NODE} topology = NODE primary_entity_rank = 0 is io_part= 0 subsets = {}P[0] info>     Part[5]= {FEM_ROOT_CELL_TOPOLOGY_PART_LINE_2} topology = LINE_2 primary_entity_rank = 1 is io_part= 0 subsets = {surface_quad4_edge2_1 , surface_quad4_edge2_2 , surface_quad4_edge2_3 , surface_quad4_edge2_4}P[0] info>     Part[6]= {FEM_ROOT_CELL_TOPOLOGY_PART_LINE_3} topology = LINE_3 primary_entity_rank = 1 is io_part= 0 subsets = {}P[0] info>     Part[7]= {FEM_ROOT_CELL_TOPOLOGY_PART_PARTICLE} topology = PARTICLE primary_entity_rank = 3 is io_part= 0 subsets = {}P[0] info>     Part[8]= {FEM_ROOT_CELL_TOPOLOGY_PART_TRIANGLE_3_2D} topology = TRIANGLE_3_2D primary_entity_rank = 3 is io_part= 0 subsets = {}P[0] info>     Part[9]= {FEM_ROOT_CELL_TOPOLOGY_PART_TRIANGLE_4_2D} topology = TRIANGLE_4_2D primary_entity_rank = 3 is io_part= 0 subsets = {}P[0] info>     Part[10]= {FEM_ROOT_CELL_TOPOLOGY_PART_TRIANGLE_6_2D} topology = TRIANGLE_6_2D primary_entity_rank = 3 is io_part= 0 subsets = {}P[0] info>     Part[11]= {FEM_ROOT_CELL_TOPOLOGY_PART_QUADRILATERAL_4_2D} topology = QUADRILATERAL_4_2D primary_entity_rank = 3 is io_part= 0 subsets = {block_1}P[0] info>     Part[12]= {FEM_ROOT_CELL_TOPOLOGY_PART_QUADRILATERAL_8_2D} topology = QUADRILATERAL_8_2D primary_entity_rank = 3 is io_part= 0 subsets = {}P[0] info>     Part[13]= {FEM_ROOT_CELL_TOPOLOGY_PART_QUADRILATERAL_9_2D} topology = QUADRILATERAL_9_2D primary_entity_rank = 3 is io_part= 0 subsets = {}P[0] info>     Part[14]= {FEM_ROOT_CELL_TOPOLOGY_PART_BEAM_2} topology = BEAM_2 primary_entity_rank = 3 is io_part= 0 subsets = {}P[0] info>     Part[15]= {FEM_ROOT_CELL_TOPOLOGY_PART_BEAM_3} topology = BEAM_3 primary_entity_rank = 3 is io_part= 0 subsets = {}P[0] info>     Part[16]= {FEM_ROOT_CELL_TOPOLOGY_PART_SHELL_LINE_2} topology = SHELL_LINE_2 primary_entity_rank = 3 is io_part= 0 subsets = {}P[0] info>     Part[17]= {FEM_ROOT_CELL_TOPOLOGY_PART_SHELL_LINE_3} topology = SHELL_LINE_3 primary_entity_rank = 3 is io_part= 0 subsets = {}P[0] info>     Part[18]= {FEM_ROOT_CELL_TOPOLOGY_PART_SPRING_2} topology = SPRING_2 primary_entity_rank = 3 is io_part= 0 subsets = {}P[0] info>     Part[19]= {FEM_ROOT_CELL_TOPOLOGY_PART_SPRING_3} topology = SPRING_3 primary_entity_rank = 3 is io_part= 0 subsets = {}P[0] info>     Part[20]= block_1 topology = QUADRILATERAL_4_2D primary_entity_rank = 3 is io_part= 1 subsets = {}P[0] info>     Part[21]= surface_1 topology = INVALID_TOPOLOGY primary_entity_rank = 1 is io_part= 1 subsets = {surface_quad4_edge2_1}P[0] info>     Part[22]= surface_2 topology = INVALID_TOPOLOGY primary_entity_rank = 1 is io_part= 1 subsets = {surface_quad4_edge2_2}P[0] info>     Part[23]= surface_3 topology = INVALID_TOPOLOGY primary_entity_rank = 1 is io_part= 1 subsets = {surface_quad4_edge2_3}P[0] info>     Part[24]= surface_4 topology = INVALID_TOPOLOGY primary_entity_rank = 1 is io_part= 1 subsets = {surface_quad4_edge2_4}P[0] info>     Part[25]= surface_quad4_edge2_1 topology = LINE_2 primary_entity_rank = 1 is io_part= 1 subsets = {}P[0] info>     Part[26]= surface_quad4_edge2_2 topology = LINE_2 primary_entity_rank = 1 is io_part= 1 subsets = {}P[0] info>     Part[27]= surface_quad4_edge2_3 topology = LINE_2 primary_entity_rank = 1 is io_part= 1 subsets = {}P[0] info>     Part[28]= surface_quad4_edge2_4 topology = LINE_2 primary_entity_rank = 1 is io_part= 1 subsets = {} P[0] info>     Part Uses information:  P[0] info>     Part[0]= {UNIVERSAL} : Uses { Node = 169 Edge = 48 Face = 0 Elem = 144 FamilyTree = 0 }P[0] info>     Part[1]= {OWNS} : Uses { Node = 169 Edge = 48 Face = 0 Elem = 144 FamilyTree = 0 }P[0] info>     Part[2]= {SHARES} : Uses { Node = 0 Edge = 0 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[3]= {AURA} : Uses { Node = 0 Edge = 0 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[4]= {FEM_ROOT_CELL_TOPOLOGY_PART_NODE} : Uses { Node = 169 Edge = 0 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[5]= {FEM_ROOT_CELL_TOPOLOGY_PART_LINE_2} : Uses { Node = 48 Edge = 48 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[6]= {FEM_ROOT_CELL_TOPOLOGY_PART_LINE_3} : Uses { Node = 0 Edge = 0 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[7]= {FEM_ROOT_CELL_TOPOLOGY_PART_PARTICLE} : Uses { Node = 0 Edge = 0 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[8]= {FEM_ROOT_CELL_TOPOLOGY_PART_TRIANGLE_3_2D} : Uses { Node = 0 Edge = 0 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[9]= {FEM_ROOT_CELL_TOPOLOGY_PART_TRIANGLE_4_2D} : Uses { Node = 0 Edge = 0 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[10]= {FEM_ROOT_CELL_TOPOLOGY_PART_TRIANGLE_6_2D} : Uses { Node = 0 Edge = 0 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[11]= {FEM_ROOT_CELL_TOPOLOGY_PART_QUADRILATERAL_4_2D} : Uses { Node = 169 Edge = 48 Face = 0 Elem = 144 FamilyTree = 0 }P[0] info>     Part[12]= {FEM_ROOT_CELL_TOPOLOGY_PART_QUADRILATERAL_8_2D} : Uses { Node = 0 Edge = 0 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[13]= {FEM_ROOT_CELL_TOPOLOGY_PART_QUADRILATERAL_9_2D} : Uses { Node = 0 Edge = 0 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[14]= {FEM_ROOT_CELL_TOPOLOGY_PART_BEAM_2} : Uses { Node = 0 Edge = 0 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[15]= {FEM_ROOT_CELL_TOPOLOGY_PART_BEAM_3} : Uses { Node = 0 Edge = 0 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[16]= {FEM_ROOT_CELL_TOPOLOGY_PART_SHELL_LINE_2} : Uses { Node = 0 Edge = 0 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[17]= {FEM_ROOT_CELL_TOPOLOGY_PART_SHELL_LINE_3} : Uses { Node = 0 Edge = 0 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[18]= {FEM_ROOT_CELL_TOPOLOGY_PART_SPRING_2} : Uses { Node = 0 Edge = 0 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[19]= {FEM_ROOT_CELL_TOPOLOGY_PART_SPRING_3} : Uses { Node = 0 Edge = 0 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[20]= block_1 : Uses { Node = 169 Edge = 48 Face = 0 Elem = 144 FamilyTree = 0 }P[0] info>     Part[21]= surface_1 : Uses { Node = 13 Edge = 12 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[22]= surface_2 : Uses { Node = 13 Edge = 12 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[23]= surface_3 : Uses { Node = 13 Edge = 12 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[24]= surface_4 : Uses { Node = 13 Edge = 12 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[25]= surface_quad4_edge2_1 : Uses { Node = 13 Edge = 12 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[26]= surface_quad4_edge2_2 : Uses { Node = 13 Edge = 12 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[27]= surface_quad4_edge2_3 : Uses { Node = 13 Edge = 12 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>     Part[28]= surface_quad4_edge2_4 : Uses { Node = 13 Edge = 12 Face = 0 Elem = 0 FamilyTree = 0 }P[0] info>    Number of fields = 5P[0] info>    Field[0]= coordinates field_array_rank= 1 field.entity_rank= NODE_RANKP[0] info>    number of field restrictions= 1P[0] info>    field restriction 0 stride[0] = 2 type= 0 Selector= {UNIVERSAL}P[0] info>    Field[1]= surface_1_df field_array_rank= 1 field.entity_rank= EDGE_RANKP[0] info>    number of field restrictions= 1P[0] info>    field restriction 0 stride[0] = 2 type= 1 Selector= surface_quad4_edge2_1P[0] info>    Field[2]= surface_2_df field_array_rank= 1 field.entity_rank= EDGE_RANKP[0] info>    number of field restrictions= 1P[0] info>    field restriction 0 stride[0] = 2 type= 1 Selector= surface_quad4_edge2_2P[0] info>    Field[3]= surface_3_df field_array_rank= 1 field.entity_rank= EDGE_RANKP[0] info>    number of field restrictions= 1P[0] info>    field restriction 0 stride[0] = 2 type= 1 Selector= surface_quad4_edge2_3P[0] info>    Field[4]= surface_4_df field_array_rank= 1 field.entity_rank= EDGE_RANKP[0] info>    number of field restrictions= 1P[0] info>    field restriction 0 stride[0] = 2 type= 1 Selector= surface_quad4_edge2_4 P[0] ======================================================== P[0] ========================================================P[0] ========================================================";
        ...
        for (unsigned itheta=0; itheta < sizeof(thetas)/sizeof(thetas[0]); itheta++)
          {
            ...
            if (dydx != 0)
              eMesh.save_as(std::string("slantThetaDYDX")+std::to_string(thetas[itheta])+".g");
            else
              eMesh.save_as(std::string("slantTheta")+std::to_string(thetas[itheta])+".g");
      ...
      TEST(perceptMesh, test_states)
      {
        ...
        Matrix rm = rotationMatrix(0, 30);
        transform_mesh(rm, eMesh);
