  ...
  if (p_size == 1)
    {
      ...
      percept::QuadFixture<double, stk::topology::TRI_3_2D > fixture( pm , nx , ny, false);
      stk::mesh::Part& part = fixture.meta_data.declare_part_with_topology("elems", stk::topology::TRI_3_2D);
