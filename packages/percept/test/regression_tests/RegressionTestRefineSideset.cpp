...
#include "RegressionTestFileLoc.hpp"
    ...
    public:
      ...
      {
        //std::cout << "running test case " << baseName << std::endl;
        ...
        for(const SideSetIdAndElemIdSides& sset : expectedRefinedSideset)
        {
            ...
            ThrowRequire(nullptr != sideSet);
            bulk.create_sideset(stk::mesh::get_sideset_parent(*surface_part)) = *sideSet;
        }
      ...
      TEST(regr_stk_sideset_refine, DISABLED_internal_sidesets)
      {
        ...
        add_test_case("ADA",
                      {{1, {{ 1, 5}, { 2, 4}                                                      }}},
                      {{1, {{7, 5}, {8, 5}, {9, 5}, {10, 5}, {11, 4}, {12, 4}, {13, 4}, {14, 4}}}},
                      testCases);
        add_test_case("ARA",
                      {{1, {{ 2, 4}                           }}},
      ...
      TEST(regr_stk_sideset_refine, get_refined_sideset)
      {
        ...
        add_test_case("Ae",
                      {{1, {{ 1, 5}, { 2, 1}                                                      }}},
                      {{1, {{ 7, 5}, { 8, 5}, { 9, 5}, {10, 5}, {11, 1}, {12, 1}, {13, 1}, {14, 1}}}},
                      testCases);
